  ...
  public byte[] createResponse(InputStream inStream) {
    ...
    try {
      ...
      if (request == null) {
        ...
        if (request.contains("convert?")) {
          Map<String, String> query_pairs = new LinkedHashMap<String, String>();
          query_pairs = splitQuery(request.replace("convert?", ""));
          String value = query_pairs.get("value");
          String from = query_pairs.get("from");
          String to = query_pairs.get("to");
          ...
          try {
            ...
            switch (from + "_" + to) {
              ...
              default:
                ...
                builder.append("Content-Type: text/html; charset=utf-8\n");
                builder.append("\n");
                builder.append("<html><head><title>Error</title></head><body><h1>Bad request</h1><p>Invalid unit of measurement provided</p></body></html>");
            }

            builder.append("HTTP/1.1 200 OK\n");
            builder.append("Content-Type: text/html; charset=utf-8\n");
            builder.append("\n");
            builder.append("<html><head><title>Conversion Result</title></head><body><h1>" + value + " " + from + " is equal to " + result + " " + to + "</h1></body></html>");
          } catch (NumberFormatException e) {
            builder.append("HTTP/1.1 400 Bad Request\n");
            builder.append("Content-Type: text/html; charset=utf-8\n");
            builder.append("\n");
            builder.append("<html><head><title>Error</title></head><body><h1>Bad request</h1><p>Invalid value provided for conversion</p></body></html>");
          } catch (Exception e) {
            builder.append("HTTP/1.1 500 Internal Server Error\n");
            builder.append("Content-Type: text/html; charset=utf-8\n");
            builder.append("\n");
            builder.append("<html><head><title>Error</title></head><body><h1>Internal Server Error</h1><p>An unexpected error occurred while processing the request</p></body></html>");
          }
          ...
          if (!query_pairs.containsKey("num1") || !query_pairs.containsKey("num2")) {
            ...
            builder.append("Content-Type: text/html; charset=utf-8\n");
            builder.append("\n");
            builder.append("Bad Request: Missing required parameters num1 and num2.");
          ...
          try {
            ...
            // Return error response if num1 or num2 are not valid integers
            builder.append("HTTP/1.1 400 Bad Request\n");
            builder.append("Content-Type: text/html; charset=utf-8\n");
            builder.append("\n");
            builder.append("Bad Request: Invalid data provided for num1 or num2.");
          }
        ...
        } else if (request.contains("multiply_squares?")) {
          Map<String, String> query_pairs = new LinkedHashMap<String, String>();
          try {
            query_pairs = splitQuery(request.replace("multiply_squares?", ""));
            ...
            for (int i = 1; i <= sumOfSquares / 2 + 1; i++) {
              if (i * i >= sumOfSquares) {
                closestPerfectSquare = i * i;
                break;
              }
            }
            ...
            builder.append("Content-Type: text/html; charset=utf-8\n");
            builder.append("\n");
            builder.append("The closest perfect square to the sum of squares of " + num1 + " and " + num2 + " is: " + closestPerfectSquare + ".");
          } catch (NumberFormatException e) {
            builder.append("HTTP/1.1 500 Internal Server Error\n");
            builder.append("Content-Type: text/html; charset=utf-8\n");
            builder.append("\n");
            builder.append("<html><head><title>Error</title></head><body><h1>Error parsing input parameters as integers</h1></body></html>");
          } catch (Exception e) {
            builder.append("HTTP/1.1 500 Internal Server Error\n");
            builder.append("Content-Type: text/html; charset=utf-8\n");
            builder.append("\n");
            builder.append("<html><head><title>Error</title></head><body><h1>An unexpected error occurred</h1></body></html>");
          }
          ...
          try {
            ...
            rez.append("<html><head><title>GitHub Repository Information</title></head><body><table border='1'>");
            rez.append("<tr><th>Repository Name</th><th>Repository ID</th><th>Owner Login</th></tr>");
            ...
            for (int i = 0; i < repos.length(); i++) {
              ...
              rez.append("<tr><td>" + repoName + "</td><td>" + repoID + "</td><td>" + ownerLogin + "</td></tr>");
            }

            rez.append("</table></body></html>");

            builder.append("HTTP/1.1 200 OK\n");
            builder.append("Content-Type: text/html; charset=utf-8\n");
            builder.append("\n");
            builder.append(rez.toString());
          } catch (JSONException e) {
            builder.append("HTTP/1.1 500 Internal Server Error\n");
            builder.append("Content-Type: text/html; charset=utf-8\n");
            builder.append("\n");
            builder.append("<html><head><title>Error</title></head><body><h1>Error parsing JSON data</h1></body></html>");
          } catch (Exception e) {
            builder.append("HTTP/1.1 500 Internal Server Error\n");
            builder.append("Content-Type: text/html; charset=utf-8\n");
            builder.append("\n");
